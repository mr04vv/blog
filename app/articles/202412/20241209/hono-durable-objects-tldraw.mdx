...
[Honoアドベントカレンダー](https://qiita.com/advent-calendar/2024/hono)9日目の記事です。前回は@Stead08さんによる「[HonoとCloudflareのサービスでHeadless CMSを作った](https://qiita.com/Stead08/items/0ca37ef87969b239193e)」でした。
