...
export const CursorDemo = () => {
  ...
  // biome-ignore lint/suspicious/noExplicitAny: Event type from range input
...
const Cursor = ({ x, y, isAnimate }: Props) => {
  ...
  return (
    ...
    >
      {/* biome-ignore lint/a11y/noSvgWithoutTitle: Decorative cursor icon */}
      <svg width="32" height="44" viewBox="0 0 24 36" fill="none">
        {/* biome-ignore lint/style/useSelfClosingElements: SVG path element */}
        <path
          fill="#3AABFF"
